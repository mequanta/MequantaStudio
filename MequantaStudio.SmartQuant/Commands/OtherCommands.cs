...
namespace MequantaStudio.SmartQuant
{
    ...
    public class ImportInstrumentListHandler : CommandHandler
    {
        ...
        protected override void Run(object dataItem)
        {
            ...
            IdeApp.Workbench.OpenDocument(new ImportInstrumentWidget(provider.Name), null, true);
        }
    }
    ...
    public class ImportHistoricalDataListHandler : CommandHandler
    {
        ...
        protected override void Run(object dataItem)
        {
            ...
            IdeApp.Workbench.OpenDocument(new ImportHistoricalDataWidget(provider.Name), null, true);
        }
    }
    ...
    public class OpenChartCommandHandler : CommandHandler
    {
        protected override void Run()
        {
            IdeApp.Workbench.OpenDocument(new BarChart(), null, true);
        }
    ...
    public class OpenGaplessChartCommandHandler : CommandHandler
    {
        protected override void Run()
        {
            IdeApp.Workbench.OpenDocument(new BarChart2(), null, true);
        }
